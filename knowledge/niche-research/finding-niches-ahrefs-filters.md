---
type: Document
title: "Finding niches, Method 2: the Ahrefs/SEMrush filter method"
...
A later pass on the same method added a second filter set:

- Volume ≥ 20000
- KD 10
- DR 5
- Words: minimum 2
- If EMDs (Exact Match Domains) appear in the results, allow at most 2, and
  none of them should have an RD (Referring Domain count) above 60
- APK not required
- Category: Tool/Info
- Word count = 2
...
- Search volume: minimum 15,000/month (Keyword Everywhere)
- Moz KD < 25
- SERP analysis: at least 3 sites with DA < 20
- Main competitor's Ahrefs DR < 20
...
worth more per visit.[^sebt-rise-notes]
