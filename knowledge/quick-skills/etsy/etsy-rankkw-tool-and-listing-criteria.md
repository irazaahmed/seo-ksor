---
type: Document
title: "RankKW: the Etsy SEO tool and listing criteria"
...
- Those listings should have **more than 2,500 views**.

### Reading the numbers

- **Sale** — shown in colour: green means sales are rising, red means
  falling, any other colour means stable.
- **Revenue** — this is *after* Etsy's commission and tax are already cut
  out, not the listing's raw price.
- **Conversion rate** — should be **at least 3%** minimum.
